...
void PickUpCollision(short item_number, ITEM_INFO* l, COLL_INFO* coll) {
	...
	if(lara.water_status == LW_ABOVE_WATER || lara.water_status == LW_WADE) {
		if((input & IN_ACTION || (GLOBAL_inventoryitemchosen != NO_ITEM && ocb == 2)) && !BinocularRange && ((l->current_anim_state == AS_STOP && l->anim_number == ANIM_BREATH && lara.gun_status == LG_NO_ARMS) || (l->current_anim_state == AS_DUCK && l->anim_number == ANIM_DUCKBREATHE && lara.gun_status == LG_NO_ARMS) || (l->current_anim_state == AS_ALL4S && l->anim_number == ANIM_ALL4S)) || lara.IsMoving && lara.GeneralPtr == (void*)item_number) {
			...
			if(l->frame_number == anims[ANIM_PICKUP].frame_base + 15 || l->frame_number == anims[ANIM_DUCKPICKUP].frame_base + 22 || l->frame_number == anims[ANIM_DUCKPICKUP].frame_base + 20 || l->frame_number == anims[ANIM_PLINTHLO].frame_base + 29 || l->frame_number == anims[ANIM_PLINTHHI].frame_base + 45 || l->frame_number == anims[ANIM_HIDDENPICKUP].frame_base + 42 || (l->anim_number == ANIM_CROWBAR && l->frame_number == anims[ANIM_CROWBAR].frame_base + 123)) {
			...
			if((l->anim_number == ANIM_DUCKPICKUPF && l->frame_number == anims[ANIM_DUCKPICKUPF].frame_base + 22) || l->frame_number == anims[ANIM_PICKUPF].frame_base + 58) {
...
void PuzzleHoleCollision(short item_num, ITEM_INFO* l, COLL_INFO* coll) {
	...
	if(((input & IN_ACTION || GLOBAL_inventoryitemchosen != NO_ITEM) && (!BinocularRange && lara.gun_status == LG_NO_ARMS && l->current_anim_state == AS_STOP && l->anim_number == ANIM_BREATH)) || (lara.IsMoving && lara.GeneralPtr == (void*)item_num)) {
		...
		if(lara.GeneralPtr == (void*)item_num && l->current_anim_state == AS_USEPUZZLE && l->frame_number == anims[ANIM_USEPUZZLE].frame_base + 80 && item->item_flags[0]) {
			if(PuzzleType == 3)

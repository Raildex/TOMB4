...
void TwoBlockPlatformFloor(ITEM_INFO* item, int x, int y, int z, int* height, height_types* height_type, int* xoff, int* zoff, int* onObject);
void TwoBlockPlatformCeiling(ITEM_INFO* item, int x, int y, int z, int* height);
...
void FallingBlockFloor(ITEM_INFO* item, int x, int y, int z, int* height, height_types* height_type, int* xoff, int* zoff, int* onObject);

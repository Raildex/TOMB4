...
void TwoBlockPlatformFloor(ITEM_INFO* item, int x, int y, int z, long* height, height_types* height_type, long* xoff, long* zoff, long* onObject);
void TwoBlockPlatformCeiling(ITEM_INFO* item, int x, int y, int z, long* height);
...
void FallingBlockCeiling(ITEM_INFO* item, int x, int y, int z, long* height);
void FallingBlockFloor(ITEM_INFO* item, int x, int y, int z, long* height, height_types* height_type, long* xoff, long* zoff, long* onObject);
